...
public class CreateLead extends ProjectWrappers {
	...
	public void login()
	{
		...
		System.out.println("Calling method1 ins
	@AfterMethod
	public void quitbrowswer1()
	{
		
		System.out.println("Calling method1 inside class");
	}
	...
	//@Test(groups={"smoke"})
	@Test(/*groups={"smoke"},*/dataProvider="fetchdata",dataProviderClass=DP.class)
	public  void main(String CN,String FN,String LN) throws InterruptedException {
